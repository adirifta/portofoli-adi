    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav_logo">Portofolio</a>
                ...
                <div className={Toggle ? "nav_menu show-menu" : "nav_menu"}>
                    <ul className="nav_list grid">
                        ...
                        <li className="nav_item">
                            <a href="#portofolio" onClick={() => setActiveNav('#portofolio')} className={activeNav === "#portofolio" ? "nav_link active-link" : "nav_link"}>
